...
import com.adryangomez.tienda.service.PedidoService;
...
public class PedidoController {
    ...
    public String Actualizar(@Valid @ModelAttribute("pedido")  Pedido pedido, BindingResult result, Model model, @PathVariable Integer id){
        if(result.hasErrors()){
            model.addAttribute("modoEdicion", true);
            return "pedido-form";
        }
