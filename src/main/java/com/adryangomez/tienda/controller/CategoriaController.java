...
import com.adryangomez.tienda.service.CategoriaService;
...
public class CategoriaController {
    ...
    public String Actualizar(@Valid @ModelAttribute("categoria") Categoria categoria, BindingResult result, Model model, @PathVariable Integer id){
        if(result.hasErrors()){
            model.addAttribute("modoEdicion", true);
            return "categoria-form";
        }
